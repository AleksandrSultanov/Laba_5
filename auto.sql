...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 03 2019 г., 21:46
...
(37, 'Tesla', 'Model_3', 2019, 3000000, 70, 'user_file/creta.png'),
(40, 'Lada', 'Granta', 2016, 300000, 57000, 'user_file/Solaris.png'),
(50, 'VW', 'Polo', 2018, 800000, 345, 'user_file/polo1_(1).png'),
(53, 'Toyota', 'Camry', 2016, 1700000, 110000, 'user_file/Camry.png');
...
(54, 'Toyota', '+79370815000', 'alexul603@gmail.ru', 'user_file/toyotainf.jpg');
...
--
ALTER TABLE `salon`
  MODIFY `id_salon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
COMMIT;
